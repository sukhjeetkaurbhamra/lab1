/*
 * app.js
 * Main JavaScript file for WEBD 6201 Lab 1
    ...
    function loadPageContent() {
        ...
        const interestsContent = `
            <div class="container py-5">
                <h1 class="text-center mb-5">My Favorite Media</h1>
                <div class="row g-4">
                    <!-- Inception -->
                    <div class="col-md-4">
        ...
        const servicesContent = `
            <div class="container py-5">
                <h1 class="text-center mb-5">My Services</h1>
                <div class="row g-4">
                    <!-- Web Development -->
                    <div class="col-md-4">
                        <div class="card h-100 text-center">
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <img src="./images/profile.jpg" alt="Sukhjeet Kaur" class="img-fluid rounded shadow-sm">
                </div>
